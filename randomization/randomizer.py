...
class Randomizer():
    def generateRandomizedTestSuite(self, config_file_path):
                ...
                for kind in flakiness_category_generators[category]:
                    ...
                    if kind == 'combination':
                        ...
                        max_expression_depth = \
                            (generator_builder.data)['random_api']["combination"]["arithmetical"][
                                "max_expression_depth"]
                        max_multiplicand = \
                            (generator_builder.data)['random_api']["combination"]["multiplication"][
                                "max_multiplicand"]
            ...
            if category == 'test_order_dependent':
                for kind in flakiness_category_generators[category]:
                    ...
                    if kind == 'multiple_classes_victim_polluter':
                        max_class_count = \
                            (generator_builder.data)['test_order_dependent']["multiple_classes_victim_polluter"][
                                "max_class_count"]
                        for i in range(25):
